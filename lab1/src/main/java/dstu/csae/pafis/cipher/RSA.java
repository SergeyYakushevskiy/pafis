...
import dstu.csae.pafis.utils.EuclidAlgorithms;
import dstu.csae.pafis.utils.NumberOperator;
   ...
   private static int minKeyBitCount = 512;
    ...
    public RSA(@NonNull BigInteger p,
        ...
        if(!m.gcd(e).equals(BigInteger.ONE)){
            throw new IllegalArgumentException(String.format(NOT_MUTUALLY_SIMPLE, m));
        }
        this.e = e;
        this.d = setD(e, m);
    }
